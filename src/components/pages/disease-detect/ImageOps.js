...
export default class ImageOps extends React.Component {
    ...
    updateImageObject(e) {
        ...
        reader.onload = () => {
            this.setState({image_object: reader.result, image_object_details: {}});
        };

    }

    // Process uploaded image by sending to backend via API call
    processImageObject() {


        this.setState(() => {

            // console.log(this.state.image_object);
                ...
                api("detect_image_objects", {
                    ...
                    if(filtered_data !== undefined){
                        ...
                        console.log(this.state.image_object_details)
                    }
                });
        });
    }
        ...
        const DisplayButtonComponent = () => {
            ...
            return (
                <Container maxWidth="md" height="100px">
                        ...
                        <Grid container justify="center" spacing={3}>
                            <Typography color="secondary">
                                1. Upload the infected crop area picture by clicking on "UPLOAD IMAGE" button.
                            </Typography>
                        </Grid>                        
                        <br></br>
                        <Grid container justify="center" spacing={3}>
                            <Typography color="secondary">
                                2. Click on "ANALYSE" to predict and generate suggestions.
                            </Typography>
                        </Grid>
                        <br></br>
                        <br></br>
                        <Grid container justify="center" spacing={3}>
                            <Typography color="secondary">
                                Supported Crops: Wheat, Barley, Canola, Sorghum, Cotton, Rice
                            </Typography>
                        </Grid>
                        <br></br>
                        <br></br>
                        ...
                        <Grid container justify="center" spacing={3}>
                            <Typography color="secondary" variant="caption">
                                * Limited to few diseases (especially, caused due to extreme temperatures).
                            </Typography>
                        </Grid>
                            <br></br>
                    <br></br>
                    <Grid container justify="center" spacing={3}>
                        {this.state.image_object && 
                            <img src={this.state.image_object} alt="" height="100vh"/>
                        }
                    </Grid>
                            <br></br>
                            <br></br>
                            <Grid container justify="center" spacing={3}>
                                <PageButton
                                  ...
                                  >
                                    Upload Image
                                    <input accept="image/*" onChange={(e) =>  this.updateImageObject(e)} type="file" style={{ display: 'none' }} />
                                </PageButton>
                            </Grid>
                    <br></br>
                    <br></br>
                        <Grid container justify="center" spacing={3}>
                            <Grid item >
                                {this.state.image_object && <Button onClick={() => this.processImageObject()} variant="contained" color="primary">
                                    Analyse 
                                </Button>}
                            </Grid>
                        </Grid>
                        <br></br><br></br>
                            {this.state.image_object_details.disease && this.state.image_object_details.probability >= 0.85 &&
                                    <>
                                            ...
                                            <Typography color="secondary">
                                                Useful Suggestions:
                                                {cropDiseaseMap[this.state.image_object_details.disease.split(",")[0]][this.state.image_object_details.disease.split(",")[1].replace(/\s+/g, '').toLowerCase()].desc.map((points) =>
                                                  <li>{points}</li>
                                                )}
                                            </Typography>
                                            <br></br>
                                            <Typography color="secondary">
                                                <a href={cropDiseaseMap[this.state.image_object_details.disease.split(",")[0]][this.state.image_object_details.disease.split(",")[1].replace(/\s+/g, '').toLowerCase()].link} target="new">Know more...</a>
                                            </Typography>
                                    </>
                            }
                            ...
                            {this.state.image_object && !this.state.image_object_details.disease && 
                                <Grid container justify="center" spacing={3}>
                                    <CircularProgress
                                        color="secondary"
                                    />
